...
import {
    Box, Container, VStack, Heading, Text, useColorModeValue, SimpleGrid, Spinner, Alert, AlertIcon,
    Modal, ModalOverlay, ModalContent, ModalHeader, ModalFooter, ModalBody, ModalCloseButton, Button, Image, Badge, Stack, useDisclosure
        ...
        <MainLayout>
                ...
                <Container maxW="container.xl">
                    <VStack spacing={8} alignItems="center" textAlign="center">
                        ...
                        <Text fontSize={getFluidFontSize(18, 22)} maxW="800px" color={headingColor}>
                            Discover insightful articles, industry news, and helpful tips to enhance your knowledge.
                        </Text>
                    </VStack>
                </Container>
            </Box>
            ...
            <AppContainer py={8}>
                {loading && (
                    <Box textAlign="center" py={20}>
                        ...
                        <Text mt={4} fontSize="lg" color={useColorModeValue("gray.600", "gray.400")}>
                            Loading blog posts...
                        </Text>
                    </Box>
                )}
            ...
            <Modal isOpen={isOpen} onClose={onClose} size="xl" scrollBehavior="inside">
                ...
                <ModalContent>
                            ...
                            <VStack spacing={4} align="start">
                                ...
                                <Stack direction="row" flexWrap="wrap" spacing={2}>
                                    {selectedPost.tags?.map((tag) => (
                                        <Badge key={tag} colorScheme="purple" borderRadius="full" px={2}>
                                            {tag}
                                        </Badge>
                                    ))}
                                </Stack>
                    ...
                    <ModalFooter>
                        <Button colorScheme="purple" mr={3} size="md" fontSize="sm" borderRadius="full" onClick={onClose}>
                            Close
                        </Button>
                    </ModalFooter>
                </ModalContent>
